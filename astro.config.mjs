...
export default defineConfig({
  ...
  integrations: [
    ...
    AstroPWA({
      ...
      includeAssets: ["favicon.ico", "francis-avatar.jpg"],
      manifest: {
        name: "Francis Oledibe",
        short_name: "Francis",
        description: "Software Engineer at Netflix sharing projects, technical write-ups, and career milestones.",
        theme_color: "#006cac",
